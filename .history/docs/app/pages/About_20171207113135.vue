<template>
  <page-container centered :title="$t('pages.about.title')">
    <section class="page-container-section">
      <h2 class="md-headline">Tele2 Material</h2>
      <strong>Material Design for Vue.js</strong>
      <p>Tele2 Material is simple, lightweight and built exactly according to the Google Material Design specs.</p>
    ...
    <section class="page-container-section">
      ...
      <div class="author-card">
        <md-avatar class="md-large">
          <img src="assets/examples/avatar.jpg" alt="Marko Siilak">
        </md-avatar>

        <div class="author-card-info">
          <span>Marko Siilak</span>
          <div class="author-card-links">
            <a href="https://github.com/siilak" target="_blank" rel="noopener">GitHub</a>
    ...
    <section class="page-container-section">
      <h2 class="md-title">How did Tele2 Material started?</h2>
      ...
      <p>I work with Vue since the 1.0 version and I love it. Tele2 Material started as a small and simple idea that I had in a boring saturday afternoon, to solve my own needs for a simple, fast and reliable solution with Material Design for Vue, because I couldn't find a good solution. So I started to develop my own library, to fix problems that I had on Angular Material's days and focusing on making things easier and practical to use.</p>
