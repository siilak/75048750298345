<template>
  <footer class="main-footer">
    <div class="main-footer-container">
      ...
      <div class="main-footer-section">
        <a href="https://github.com/marcosmoura" target="_blank">{{ $t('madeWith') }} <span class="red">❤</span> {{ $t('by') }} Marko Siilak</a>
      </div>
    </div>
  </footer>
</template>
...
<style lang="scss" scoped>
  ...
  @import "~tele2-material/components/MdLayout/mixins";
  @import "~tele2-material/theme/engine";
