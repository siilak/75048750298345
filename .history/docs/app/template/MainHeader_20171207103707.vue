  ...
  <md-toolbar class="main-header" :class="mainHeaderClasses" :md-elevation="mainHeaderElevation">
    <div class="md-toolbar-row">
      <div class="md-toolbar-section-start">
        ...
        <div class="md-title">
          <span class="md-xsmall-hide">Tele2 Material</span>
      ...
      <div class="md-toolbar-section-end">
        ...
        <md-button href="http://github.com/vuematerial/tele2-material" target="_blank" class="md-icon-button">
...
<script>
  ...
  import logo-vue-material from './../components/LogoVueMaterial.vue'
...
<style lang="scss" scoped>
  @import "~tele2-material/components/MdAnimation/variables";
  @import "~tele2-material/components/MdElevation/mixins";
