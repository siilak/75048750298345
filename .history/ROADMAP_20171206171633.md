# Roadmap for Tele2 Material beta!

As I told [couple months ago](https://github.com/vuematerial/tele2-material/issues/921), I am developing a new Tele2 Material from scratch, with better support, an easy way to integrate and way more reliable. And this new version is just around the corner.
...
Tele2 Material do not run under the umbrella of any company or something like that, and is an independent project created by me on spare time. It became one of the most used UI Libraries for Vue.js.
