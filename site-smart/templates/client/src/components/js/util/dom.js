...
export const Transition = {
    ...
    inProgress(element) {
        return hasClass(element, 'tele2-transition');
    }

};

var animationcancel = 'animationcancel',
    animationPrefix = 'tele2-animation-',
    clsCancelAnimation = 'tele2-cancel-animation';
