function plugin(UIkit) {
    ...
    UIkit.component('notification', {
        ...
        defaults: {
            ...
            group: null,
            pos: 'top-center',
            clsClose: 'tele2-notification-close',
            clsMsg: 'tele2-notification-message'
        },

        created() {

            if (!containers[this.pos]) {
                containers[this.pos] = append(UIkit.container, `<div class="tele2-notification tele2-notification-${this.pos}"></div>`);
            }
            ...
            this.$mount(append(container,
                `<div class="${this.clsMsg}${this.status ? ` ${this.clsMsg}-${this.status}` : ''}">
                    <a href="#" class="${this.clsClose}" data-tele2-close></a>
