function plugin(UIkit) {
    ...
    UIkit.component('sortable', {
        ...
        defaults: {
            ...
            animation: 150,
            threshold: 5,
            clsItem: 'tele2-sortable-item',
            clsPlaceholder: 'tele2-sortable-placeholder',
            clsDrag: 'tele2-sortable-drag',
            clsDragState: 'tele2-drag',
            clsBase: 'tele2-sortable',
            clsNoDrag: 'tele2-sortable-nodrag',
            clsEmpty: 'tele2-sortable-empty',
            clsCustom: '',
            handle: false
        },
