export default {
  aboutMaterial: 'About Tele2 Material',
  madeWith: 'Made with',
  by: 'by',
  pages: {
    home: {
    ...
    gettingStarted: {
      ...
      introduction: 'Tele2 Material is the best integration between Vue.js and Material Design specs! You can easily configure it to suit all your needs. All you have to do is choose an installation method that fits you better and follow it\'s instructions. Let\'s start!',
