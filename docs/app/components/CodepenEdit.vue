...
<script>
  const vueMaterialUrl = 'https://unpkg.com/tele2-material@beta'
    ...
    computed: {
      ...
      externalStyles () {
        return [
          ...
          `${vueMaterialUrl}/dist/tele2-material.min.css`,
          `${vueMaterialUrl}/dist/theme/default.css`
        ].join(';')
      },
      apiJson () {
        return {
          title: `Tele2 Material - ${camelCaseToDash(this.component.name)}`,
          description: 'It\'s about stuff.',
          private: false,
          tags: ['tele2-material', 'material-design'],
          editors: '111',
          layout: 'left',
          html: `${this.html}`,
