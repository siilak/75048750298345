...
<template>
  <page-container centered :title="$t('pages.scrollbar.title')">
    <div class="page-container-section">
      ...
      <note-block alert>The scrollbars <strong>only</strong> works on <code>html</code> tag and on Tele2 Material components, like <code>md-content</code> or <code>md-drawer</code>. Due to CSS limitations, the style will be applied only on Webkit/Blink browsers (Chrome, Safari and Opera).</note-block>
    </div>
