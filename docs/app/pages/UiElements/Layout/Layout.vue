...
<template>
  <page-container centered :title="$t('pages.layout.title')">
    ...
    <div class="page-container-section">
      <h2>Breakpoints</h2>
      <p>Tele2 Material layout uses some breakpoints for responsiveness:</p>
    ...
    <div class="page-container-section">
      ...
      <p>The layout system in Tele2 Material is essentially based on columns and makes use of flexbox to be flexible enough and give the best experience with a great and easy API.</p>
    ...
    <div class="page-container-section">
      <p>By default layout items do not have space between each other. This can be kind of bad for regular layouts, like a list of card, for example. You can set Tele2 Material to calculate automatically the space between elements and those spaces are based on the screen width, using the same breakpoints:</p>
