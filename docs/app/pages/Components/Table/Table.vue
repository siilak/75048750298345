...
<template>
  <page-container centered :title="$t('pages.table.title')">
    <div class="page-container-section">
      <p>Data tables display sets of raw data. They usually appear in desktop enterprise products. They are the component that have more features in all Tele2 Material ecosystem. There is a lot of options that you can tweak to change and impact on the table layout.</p>
    ...
    <div class="page-container-section">
      <p>In pages that only have a table, you can put this table within a card. Fortunately Tele2 Material provide an options out of the box to add a table card without any efforts:</p>
    ...
    <div class="page-container-section">
      ...
      <p>Tele2 Material have advanced tables that can handle with your data, sorting, selecting and manipulating it. You can pass a <code>v-model</code> with you data and tweak the table to suit your needs. Along with that, you should give to data table a custom template. This will allow the table to have it's own markup and display all rows for you. This is really powerfull!</p>
    ...
    <div class="page-container-section">
      <p>Sometimes the internal sort from Tele2 Material will not be enough for you. You can provide your own sort function:</p>
      <code-example title="Custom Sort function" :component="examples['table-custom-sort']" />
    </div>

    <div class="page-container-section">
      <p><strong>With large datasets comes great responsability</strong>... with your user. We know that Tele2 Material tables have a great layout, but we need to care about the usability of your screens. Fixed headers will make easier to interact with the table, by keeping all options always visible:</p>
