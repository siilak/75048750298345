...
<template>
  <page-container centered :title="$t('pages.dialog.title')">
    <div class="page-container-section">
      ...
      <p>The component can be used with a custom markup, using the auxiliary components or with presets made by Tele2 Material. Those presets emulates the default Dialogs from Javascript, like confirm, alert and prompt.</p>
    </div>
