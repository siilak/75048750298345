...
<template>
  <page-container centered :title="$t('pages.select.title')">
    ...
    <div class="page-container-section">
      ...
      <p>Tele2 Material selects works alogn with <code>md-option</code> component to provide the possible selection options. You should use it inside the <code>md-field</code> component The selection is will always react to changes on the <code>v-model</code> prop:</p>
