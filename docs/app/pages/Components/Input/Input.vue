...
<template>
  <page-container centered :title="$t('pages.input.title')">
    <div class="page-container-section">
      ...
      <p>Tele2 Material fields works with a <code>md-field</code> as a wrapper with a input component inside, that can be <code>md-input</code>, <code>md-textarea</code> or even a <code>md-select</code>.</p>
    ...
    <div class="page-container-section">
      ...
      <p>Fields mimics the HTML5 attributes to keep the same compatibility with native inputs, but giving extra options. This allows Tele2 Material to setup the <code>md-field</code> according with the input options.</p>
    ...
    <div class="page-container-section">
      ...
      <p>Tele2 Material have validation states to show error messages. You can use it along with other Vue 3rd party validation libraries, like Vuelidate or Vee-Validate:</p>
