...
<template>
  <page-container centered :title="$t('pages.emptyState.title')">
    <div class="page-container-section">
      ...
      <p>The most basic empty state displays a non-interactive image and a text tagline. For that you can use an icon, title and an empty state description. Tele2 Material already provide a nice design for your empty states, but you can always create your own design on top of <code>md-empty-state</code>.</p>
