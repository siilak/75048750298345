<template>
  <page-container centered :title="$t('pages.themePrebuilt.title')">
    <div class="page-container-section">
      ...
      <p>Tele2 Material comes with some prebuilt themes for you to quickly prototype an app. The preset themes bring all styles for all components and elements that Tele2 Material have.</p>
