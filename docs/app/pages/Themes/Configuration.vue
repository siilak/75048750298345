<template>
  <page-container centered :title="$t('pages.themeConfiguration.title')">
    ...
    <div class="page-container-section">
      ...
      <p>The simplest markup to create a theme in Tele2 Material is:</p>

      <code-example label="SCSS" lang="scss">
        @import "~tele2-material/dist/theme/engine"; // Import the theme engine
        ...
        @import "~tele2-material/dist/theme/all"; // Apply the theme
      </code-example>
    </div>

    <div class="page-container-section">
      <h3 class="md-title">Available colors</h3>
      <p>Tele2 Material comes with the nice Material Design <a href="https://material.io/guidelines/style/color.html#color-color-palette" target="_blank">color palette</a>. You can fully use it to build your themes, using the available colors along with the color shade.</p>
    ...
    <div class="page-container-section">
      ...
      <p>Tele2 Material have default theme colors:</p>
      <ul>
    ...
    <div class="page-container-section">
      ...
      <code-example label="SCSS" lang="scss">
        ...
        @import "~tele2-material/dist/components/MdButton/theme"; // Apply the Button theme
        @import "~tele2-material/dist/components/MdContent/theme"; // Apply the Content theme
        @import "~tele2-material/dist/components/MdToolbar/theme"; // Apply the Toolbar theme
      </code-example>
    </div>
  </page-container>
</template>
